...
func (basis *WhitePillars) Read(dateBegin, dateEnd time.Time) ([]model.TypeReport, error) {
...
//GetData выдача списка прочитанных данных из эксель
func (basis *WhitePillars) GetData() []model.TypeReport {
	return basis.ListReport
}

//GetName выдача данных по имени коннектора
func (basis *WhitePillars) GetName() string {
	return basis.Name
}
